...
export default function HomePage() {
  ...
  const handleSaveClick = () => {
    ...
    localStorage.setItem('gridLayouts', JSON.stringify(currentLayouts));
    setIsEditMode(false);
  };
    ...
    <div className="container mx-auto px-4 py-8 relative">
      ...
      <div className="flex justify-end mb-4">
        {!isEditMode ? (
          <button 
            ...
            className="bg-dark-blue hover:bg-dark-blue-light text-white p-2 rounded-md shadow-sm border border-primary-700 transition-colors"
            title="Edit Layout"
          >
      ...
      {showNameDialog && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-dark-blue border border-primary-700 rounded-lg shadow-lg p-6 w-96">
